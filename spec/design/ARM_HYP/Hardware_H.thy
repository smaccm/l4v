...
definition
writeContextIDAndPD :: "hardware_asid \<Rightarrow> paddr \<Rightarrow> unit machine_monad"
where
"writeContextIDAndPD \<equiv> error []"
...
where
"getHDFAR \<equiv> error []"

definition
addressTranslateS1CPR :: "vptr \<Rightarrow> vptr machine_monad"
where
