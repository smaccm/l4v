...
(*|  PageDirectoryCap _ _ \<Rightarrow>undefined
| PageTableCap p mapped_address \<Rightarrow> undefined
| PageCap p R pgsz mapped_address \<Rightarrow>undefined
| ASIDControlCap \<Rightarrow> undefined
| ASIDPoolCap p base \<Rightarrow> undefined *)
(*
definition
  arch_decode_invocation :: 
  "data \<Rightarrow> data list \<Rightarrow> cap_ref \<Rightarrow> cslot_ptr \<Rightarrow> arch_cap \<Rightarrow> (cap \<times> cslot_ptr) list \<Rightarrow> 
