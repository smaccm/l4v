...
Most architectures provide some information about virtual memory and hypervisor faults in hardware registers. Other information is implied by the hardware's choice between a set of different trap handlers. The latter is represented in this model by the following data type.

> type VMFaultType = Arch.VMFaultType

> type HypFaultType = Arch.HypFaultType
