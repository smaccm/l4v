...
locale DetSchedDomainTime_AI =
  ...
  assumes arch_tcb_sanitise_condition_domain_list_inv'[wp]:
    "\<And>P t. \<lbrace>\<lambda>s. P (domain_list s)\<rbrace> arch_tcb_sanitise_condition t \<lbrace>\<lambda>_ s. P (domain_list s)\<rbrace>"
  ...
  assumes arch_tcb_sanitise_condition_domain_time_inv'[wp]:
    "\<And>P t. \<lbrace>\<lambda>s. P (domain_time s)\<rbrace> arch_tcb_sanitise_condition t \<lbrace>\<lambda>_ s. P (domain_time s)\<rbrace>"
